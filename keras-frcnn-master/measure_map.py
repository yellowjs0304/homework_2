...
parser.add_option("-n", "--num_rois", dest="num_rois",
				help="Number of ROIs per iteration. Higher means more memory use.", default=32)#ROI 조절 가능
...
parser.add_option("--model", dest="model", help="Model name for test", default='model_frcnn.hdf5')
#특정 모델을 실험하고 싶을땐 해당 옵션을 넣어주고, 대신 하단의 C.model_path를 options.model로 변경해주어야 함. 
#Network 구성에 따라 단순히 options.model로 변경해줬을 때 n_roi나 cnn종류에 따라 오류가 발생할 수 있음.
