...
커맨드 예시
python train.py --model_type=yolo3_mobilenet_lite --anchors_path=configs/yolo3_anchors.txt --annotation_file=trainval_misaeng.txt --classes_path=configs/misaeng_classes.txt --eval_online --save_eval_checkpoint
...
if __name__ == '__main__':
    ...
    parser.add_argument('--init_epoch', type=int,required=False, default=0,
        help = "Initial training epochs for fine tune training, default=%(default)s // FineTuning 또는 학습 시 초기 Epoch")
    parser.add_argument('--total_epoch', type=int,required=False, default=20,
        help = "Total training epochs, default=%(default)s // 전체 Epoch :초기 Default 값은 250이었음")
